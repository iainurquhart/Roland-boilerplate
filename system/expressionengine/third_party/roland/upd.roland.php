...
/**
 * Roland Module Install/Update File
 *
 * @package		ExpressionEngine
 * @subpackage	Addons
 * @category	Module
...
class Roland_upd {
	...
	public function uninstall()
	{
		...
		$this->EE->db->where('module_name', 'Roland')
					 ->delete('modules');
...
/* End of file upd.roland.php */
/* Location: /system/expressionengine/third_party/roland/upd.roland.php */